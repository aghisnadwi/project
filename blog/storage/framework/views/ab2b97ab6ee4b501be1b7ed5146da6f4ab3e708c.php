...
<body style="background-color:black">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo e(url(config('adminlte.dash715871851board_url', 'home'))); ?>">iseng iseng</a>
        </div>
        <!-- /.login-logo -->
        <div class="login-box-body bg-green">
            <p class="login-box-msg">Webb biasa aja</p>
            <form action="<?php echo e(url(config('adminlte.login_url', 'login'))); ?>" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <button type="submit"
                                class="btn btn-warning btn-block btn-flat">masuk</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
...
<?php echo $__env->make('adminlte::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\aghisna dwi S.H\blog\vendor\jeroennoten\laravel-adminlte\src/../resources/views/login.blade.php ENDPATH**/ ?>